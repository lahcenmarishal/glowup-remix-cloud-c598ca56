                    ...
                    <div className="group">
                      <div className="flex flex-col md:hidden">
                        ...
                        <div className="bg-[#1a1a1a] px-6 py-8">
                          <h2 className="mb-3 font-display text-3xl font-bold leading-tight text-background">
    {s.title}
  </h2>

  <p className="text-base md:text-lg leading-relaxed text-background/70">
    {s.description}
  </p>

  <a
    href="/contact"
    className="mt-6 inline-block text-base md:text-lg font-semibold text-red-600 underline decoration-2 underline-offset-4 transition-colors duration-200 hover:text-red-700"
  >
                        ...
                        {imageFirst ? (
                          <>
                            ...
                            <div className="flex flex-col justify-center bg-[#1a1a1a] px-12 py-16 lg:px-20">
                              <h2 className="mb-3 font-display text-xl font-bold leading-tight text-background">
    {s.title}
  </h2>
