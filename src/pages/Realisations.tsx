                    ...
                    <div className="group">
                      ...
                      <div className="flex flex-col md:hidden">
                        ...
                        <div className="bg-[#1a1a1a] px-6 py-8">
                          <h2 className="mb-4 font-display text-2xl font-bold uppercase leading-tight text-white">{r.title}</h2>
                        ...
                        {imageFirst ? (
                          <>
                            ...
                            <div className="flex flex-col justify-center bg-[#1a1a1a] px-12 py-16 lg:px-20">
                              <h2 className="mb-6 font-display text-3xl font-bold uppercase leading-tight text-white lg:text-4xl xl:text-5xl">{r.title}</h2>
                              <p className="max-w-lg text-sm leading-relaxed text-white/70 lg:text-base">{r.description}</p>
                            </div>
                          </>
                        ) : (
                          <>
